...
IMAGE_SIZE = 256
BATCH_SIZE = 1
OUTPUT_PATH = '2dejoinpro_block_boss_bow_0.4'
payload = 0.4
...
class MyDataset(Dataset):
    def __init__(self, partition, transform):
        ...
        self.cover_dir = '/public/fanzexin/BOSSbase_1.01_BOWS2_256'
        self.stego_dir = '/public/fanzexin/dejoin_matlab/stego_BOSSBOWS_HILL_2dejoin_block_payload0.4'
...
if __name__ == '__main__':
    path = '/public/fanzexin/XuNet/stego_hill_boss_bow_0.4_AUG/model_params.pt'
