...
IMAGE_SIZE = 256
BATCH_SIZE = 1
OUTPUT_PATH = '/home/fanzexin/yenet_adv_hill_boss_bow_0.1'
payload = 0.1
...
def test(model, device, loader):
    ...
    for idx, sample in enumerate(loader):
        ...
        loss.backward()
        grad = data.grad.data
        tmp = grad[0, :, :].cpu().detach().numpy().copy().reshape(IMAGE_SIZE, IMAGE_SIZE)
        ...
        if correct: # 分析器能准确分类
            ...
            while GAMMA < GAMMA_MAX:
                ...
                tmp = grd[0, :, :].cpu().detach().numpy().copy().reshape(IMAGE_SIZE, IMAGE_SIZE)
...
class MyDataset(Dataset):
    def __init__(self, partition, transform):
        ...
        self.stego_dir = '/home/fanzexin/HILL_2dejoin_payload0.1'
...
if __name__ == '__main__':
    path = '/home/fanzexin/XuNet/yenet_boss_bows_hill_0.1_AUG/model_params.pt'
