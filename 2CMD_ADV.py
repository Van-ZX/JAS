...
IMAGE_SIZE = 256
BATCH_SIZE = 1
OUTPUT_PATH = '/home/fanzexin/ye_adv_cmd_0.4'
payload = 0.4
...
class MyDataset(Dataset):
    def __init__(self, partition, transform):
        ...
        self.stego_dir = '/home/fanzexin/stego_BOSS_BOWS_HILL_4CMD_payload0.4'
...
if __name__ == '__main__':
    path = '/home/fanzexin/XuNet/yenet_boss_bows_hill_0.4/model_params.pt'
