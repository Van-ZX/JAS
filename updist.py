...
IMAGE_SIZE = 256
BATCH_SIZE = 1
OUTPUT_PATH = '/home/fanzexin/test0.4'
payload = 0.4
...
class MyDataset(Dataset):
    def __init__(self, partition, transform):
        ...
        self.stego_dir = '/home/fanzexin/2DejoinUpdist_beta0.1_payload0.4'
...
if __name__ == '__main__':
    path = '/home/fanzexin/XuNet/matlab_no_block_2dejoinpro_hill_boss_bow_0.4_retrain/model_params.pt'
